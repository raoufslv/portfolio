...
const Home = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = "src/assets/cv.pdf"; // Replace with the desired file path
        ...
        >
          ...
          <div className="flex flex-col mx-10 sm:mx-20 md:mx-40 lg:mx-96 gap-5 py-14">
            ...
            <a href="/EkriEchri">
              <Card
                Headline={"Ekri&Echri"}
                PicPath="src/assets/Ekri&Echri.png"
                summary={p1}
              ></Card>
            </a>
            ...
            <a href="/Tomobiltek">
              <Card
                Inverse={true}
                Headline={"Tomobiltek"}
                PicPath="src/assets/Tomobiltek.png"
                summary={p2}
              ></Card>
            </a>
            ...
            <a href="/AIarticle">
              <Card
                ...
                PicPath="src/assets/AI-site.png"
                summary={p3}
              ></Card>
            </a>
          </div>
